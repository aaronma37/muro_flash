...
//Calibration 
if (counter11>10){
XT << XT(0)+agentVector[iTemp].velo*167/T*cos(XT(2)),XT(1)+agentVector[iTemp].velo*167/T*sin(XT(2)),XT(2)+agentVector[iTemp].omega*57/52/T/OmegaC;
}
...
OmegaC=OmegaC+.3*((XT(2)+2*3.14)-(X(2)+2*3.14));
  XT=X;
  counter12=counter11;

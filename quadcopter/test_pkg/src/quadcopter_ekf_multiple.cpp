...
void iptCallback(const geometry_msgs::TwistStamped::ConstPtr& ipt)
{
if(ipt->header.frame_id.compare("Gypsy Danger")==0){
        k=0;
    }
    else if (ipt->header.frame_id.compare("Typhoon")==0){
        k=1;
    }
else if (ipt->header.frame_id.compare("dummy 1")==0){
        k=101;
    }
else if (ipt->header.frame_id.compare("dummy 2")==0){
        k=102;
    }
else if (ipt->header.frame_id.compare("dummy 3")==0){
        k=103;
    }
else if (ipt->header.frame_id.compare("dummy 4")==0){
        k=104;
    }
else if (ipt->header.frame_id.compare("dummy 5")==0){
        k=105;
    }
else if (ipt->header.frame_id.compare("dummy 6")==0){
        k=106;
    }
    twist[k].linear=ipt->twist.linear;
    twist[k].angular=ipt->twist.angular;
}
...
int main(int argc, char **argv)
{
    ...
    void iptCallback(const geometry_msgs::TwistStamped::ConstPtr&);

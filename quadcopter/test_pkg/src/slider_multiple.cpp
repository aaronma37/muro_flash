...
void PID(int i)
{
    ...
    // Linear Sliding Mode
    sX[i] = -sliderSlope*sliderMod*poseError[i].pose.position.x + velEstimation[i].linear.x;
    sY[i] = -sliderSlope*sliderMod*poseError[i].pose.position.y + velEstimation[i].linear.y;
